...
# Awesome Informatik- und KI-Vorbildung
...
Es gibt von mir die weiteren Schwesterseiten im Kontext Informatik/KI: [Digitaler Ressourcen-Pool Informatik/KI](https://github.com/cyberlytics/awesome-basics) und [Agentic Engineering](https://github.com/cyberlytics/awesome-6GL)
...
- Angewandter Kinderschutz
	...
	- Altersstufen:
		| Alter     | Schwerpunkt                                                                   |
		| --------- | ----------------------------------------------------------------------------- |
		| **≤ 8**   | sehr restriktiv, kein unbegleiteter Internetzugang, YouTube Kids, wenige Apps |
		| **8–11**  | Family Link/Apple Family, App-Freigaben, starke Inhaltsfilter, Screentime     |
		| **12–13** | Online-Kommunikation, Gaming-Chats, Datenschutz, SafeSearch                   |
		| **14–15** | Social Media, Cybermobbing, Grooming, Sextortion, Eigenverantwortung          |
		| **16–17** | weitgehend selbstständig, Fokus auf Medienkompetenz                           |
- Schulen
...
- Soziale Netzwerke für Frauen/Mädchen
...
Was habe ich übersehen? Habt ihr irgendwelche Empfehlungen?

Beiträge sind herzlich willkommen. Bitte haltet euch an die Richtlinien für Beiträge und stellt sicher, dass euer Pull-Request den folgenden Richtlinien entspricht:

- Erstelle für jeden Vorschlag einen eigenen Pull-Request.
- Halte die Beschreibungen kurz und einfach.
- Überprüfe Rechtschreibung und Grammatik.
- Stelle sicher, dass dein Texteditor so eingestellt ist, dass er nachgestellte Leerzeichen entfernt.
- Versuche, deinen Pull-Request und den Titel so aussagekräftig wie möglich zu gestalten.
